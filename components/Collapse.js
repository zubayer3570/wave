...
const Collapse = ({ question, answer }) => {
    ...
    return (
        <>
            <div className='rounded-2xl shadow-custom-2 cursor-pointer mb-[10px] cursor-default'>
                ...
                <div className={`overflow-hidden max-h-0 duration-200 ease-in-out ${accState && 'max-h-[400px]'}`}>
